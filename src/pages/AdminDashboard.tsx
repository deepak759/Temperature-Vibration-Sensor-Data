...
export default function AdminDashboard() {
  ...
  // Get admin plants
  const adminPlants =
    user?.plantAccess.filter((access) => access.accessType === "admin") || [];
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-center text-slate-600">
              You don't have admin access to any plants.
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600 mt-1">
                Manage users and alert emails for your plants
              </p>
            </div>
            <div className="w-64">
              <Select
              ...
              <TabsContent value="users" className="space-y-4">
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Add a user with viewer access to{" "}
                          {selectedPlant.plantName}. Credentials will be sent to
                          their email.
                        </DialogDescription>
                      </DialogHeader>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Users with access to {selectedPlant.plantName}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {loading ? (
              ...
              <TabsContent value="alerts" className="space-y-4">
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Add an email to receive alerts when vibration exceeds
                          threshold for {selectedPlant.plantName}
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div className="space-y-2">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Emails that receive alerts for {selectedPlant.plantName}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {loading ? (
                          ...
                          {alertEmails.length === 0 ? (
                            ...
                            alertEmails.map((alertEmail) => (
                              <TableRow key={alertEmail._id}>
                                ...
                                <TableCell>
                                  {alertEmail.addedBy.username}
                                </TableCell>
                                <TableCell>
                                  {new Date(
                                    alertEmail.createdAt,
                                  ).toLocaleDateString()}
                                </TableCell>
                                <TableCell>
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleRemoveAlertEmail(alertEmail._id)
                                    }
                                  >
