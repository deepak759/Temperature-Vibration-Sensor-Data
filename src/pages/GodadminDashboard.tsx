...
export default function GodadminDashboard() {
  ...
  const handleAssignAdmin = async () => {
    ...
    try {
      ...
      if (assignMode === "new") {
        toast.success(
          "Admin user created successfully! Credentials have been sent to their email.",
        );
      } else {
        ...
        <TabsContent value="management" className="space-y-6 mt-0">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600 mt-1">Manage all plants and users</p>
            </div>
          </div>
                  ...
                  <Card key={plant._id}>
                    ...
                    <CardContent>
                      ...
                      <div className="flex gap-2">
                        <Dialog
                          open={
                            isAdminDialogOpen && selectedPlant === plant._id
                          }
                          onOpenChange={(open) => {
                          ...
                          <DialogContent>
                            ...
                            <div className="space-y-4">
                              <div className="flex gap-2">
                                <Button
                                  variant={
                                    assignMode === "new" ? "default" : "outline"
                                  }
            ...
            <TabsContent value="users" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    View all users and their plant access
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                            ...
                            {user.plantAccess.map((access: any) =>
                              access.accessType === "admin" ? (
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    handleRemoveAdmin(access.plantId, user.id)
                                  }
                                  className="mr-2"
                                >
                                  Remove Admin
